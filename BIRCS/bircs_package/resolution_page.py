...
class ResolutionPage:
    ...
    def show_case_details(self, case):
        ...
        # --- THE MAGIC: If it was approved for Re-open, show Phase 1 History! ---
        ...
        # Smart Suggestions
        ctk.CTkLabel(self.details_frame, text="✨ AI Smart Suggestions", font=("Arial", 12, "bold"),
    ...
    def display_smart_suggestions(self, narrative, zone, category):
        ...
        for item in suggestions:
            card = ctk.CTkFrame(self.suggestion_frame, fg_color="#F0F8FF", border_color="#27AE60", border_width=1,
                                cursor="hand2")
            card.pack(fill="x", pady=5)
            card.bind("<Button-1>", lambda e, t=item['text']: self.insert_ai_suggestion(t))
            ctk.CTkLabel(card, text=item['text'], font=("Arial", 11), wraplength=450, justify="left",
                         cursor="hand2").pack(anchor="w", padx=10, pady=10)
    ...
    def submit_resolution(self):
        ...
        # The Engine's smart save handles Phase 1 vs Phase 2 automatically!
